...
export class SearchView extends BaseView {
    ...
    syncFormControls() {
        ...
        const maxRating = document.getElementById('max_rating');
        const minRatingValue = document.getElementById('min_rating_value');
        const maxRatingValue = document.getElementById('max_rating_value');
    ...
    setupEventListeners() {
        const form = document.getElementById('form-advance-search');
