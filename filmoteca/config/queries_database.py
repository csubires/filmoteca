...
TAG_QUERY_REPORT = {
	...
	'devalued_movies': 'SELECT id_movie, title, year, duration_str, ratings, urlpicture, CASE WHEN id_subgenre IS NULL THEN id_genre ELSE id_subgenre END, pathfile FROM movies WHERE ratings < 6 AND hdd_code = 0 ORDER BY ratings ASC',
